...
class node_Lyons_Reservoir_Storage_Value(WaterLPParameter):
    ...
    def _value(self, timestep, scenario_index):
        ...
        current_elevation = self.model.parameters["node/Lyons Reservoir/Elevation"].value(timestep, scenario_index)
        max_elevation = self.model.parameters["node/Lyons Reservoir/Storage Capacity"].value(timestep, scenario_index)
        min_elevation = self.model.parameters["node/Lyons Reservoir/Inactive Pool"].value(timestep, scenario_index)
