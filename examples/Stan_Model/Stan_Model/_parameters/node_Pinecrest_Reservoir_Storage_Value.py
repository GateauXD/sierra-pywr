...
class node_Pinecrest_Reservoir_Storage_Value(WaterLPParameter):
    ...
    def _value(self, timestep, scenario_index):
        ...
        current_elevation = self.model.parameters["node/Pinecrest Reservoir/Elevation"].value(timestep, scenario_index)
        max_elevation = self.model.parameters["node/Pinecrest Reservoir/Storage Capacity"].value(timestep, scenario_index)
        min_elevation = self.model.parameters["node/Pinecrest Reservoir/Inactive Pool"].value(timestep, scenario_index)
